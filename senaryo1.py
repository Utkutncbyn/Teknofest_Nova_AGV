...
while True:
    ...
    if len(contours) > 0:
        ...
        ## Dönüş Case ve Komutları ##
            ...
            if qr == "Q7" and counter_7 == 0:
                counter_7 += 1
                sag()
                time.sleep(1) 
            elif qr == "Q11" and counter_11 == 0:
                counter_11 += 1
                time.sleep(0.5)
                sag()
                time.sleep(1)
            elif qr == "Q50" and counter_50 == 0:
                counter_50 += 1
                dur()
                time.sleep(2)
                YukAl()
            ...
            elif qr == "Q52" and counter_52 == 0:
                counter_52 += 1
                time.sleep(0.5)
                sag()
                time.sleep(1)
            elif qr == "Q24" and counter_24 == 0:
                counter_24 += 1
                time.sleep(0.5)
                sag()
                time.sleep(1)
            elif qr == "Q40" and counter_40 == 0:
                counter_40 += 1
                time.sleep(0.5)
                sol()
                time.sleep(1)
            elif qr == "Q3" and counter_3 == 0:
                counter_3 += 1
                time.sleep(0.5)
                sol()
                time.sleep(1)
            elif qr == "Q35" and counter_35 == 0:
                counter_35 += 1
                time.sleep(0.5)
                sol()
                time.sleep(1)
